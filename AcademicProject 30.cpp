/*Do wektora o n elementach (n - stala) wczytaæ dane o samochodach postaci (rocznik, cena, marka) jako pola rekordow.
Wydrukowac cene najstarszego samochodu (lub pierwszego napotkanego sposrod kilku najstarszych)
i marke najdrozszego samochodu (lub pierwszego napotkanego spoœród kilku najdro¿szych).*/
